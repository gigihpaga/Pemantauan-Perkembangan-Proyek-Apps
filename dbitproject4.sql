...
-- Dumping data for table dbitproject.it_modul: ~5 rows (approximately)
...
INSERT INTO `it_modul` (`idmodul`, `kodemodul`, `namamodul`, `tipemodul`, `status`, `deskripsi`, `idsubproduk`, `idproduk`, `createby`, `createdate`, `modifby`, `modifdate`) VALUES
	...
	(4, NULL, '111', 1, 0, '', 1, 1, NULL, '2021-02-22 15:51:30', NULL, NULL),
	(5, NULL, '222', 1, 0, '', 2, 1, NULL, '2021-02-22 15:51:45', NULL, NULL),
	(6, NULL, '333', 3, 0, '', 2, 1, NULL, '2021-02-22 15:52:38', NULL, NULL);
...
INSERT INTO `it_proyek` (`idproyek`, `namaproyek`, `deskripsi`, `idtipeproyek`, `tahun`, `createby`, `createdate`, `modifby`, `modifdate`) VALUES
	...
	(6, 'proyek 2', '', 1, '2021', 'admin', '2021-02-22 15:53:21', 'admin', '2021-02-22 15:53:49');
...
-- Dumping data for table dbitproject.it_proyekdetail: ~8 rows (approximately)
...
INSERT INTO `it_proyekdetail` (`idproyekdetail`, `idproyek`, `idmodul`, `sprint`, `pic_ba`, `pic_dev`, `pic_qc`, `pic_user`, `deskripsi`, `createby`, `createdate`, `modifby`, `modifdate`) VALUES
	(1, 2, 1, 1, '2', '3', '4', '5', 'penambahan fasilitas export', NULL, NULL, NULL, NULL),
	...
	(8, 6, 6, 3, '2', '3', '4', '5', '', 'admin', '2021-02-22 15:53:49', NULL, NULL),
	(9, 6, 4, 3, '2', '3', '4', '5', '', 'admin', '2021-02-22 15:53:49', NULL, NULL),
	(10, 6, 5, 3, '2', '3', '4', '5', '', 'admin', '2021-02-22 15:53:49', NULL, NULL);
...
-- Dumping data for table dbitproject.it_proyekhistory: ~31 rows (approximately)
...
INSERT INTO `it_proyekhistory` (`idproyekhistory`, `idproyekdetail`, `pic`, `role`, `aksi`, `createby`, `createdate`, `modifby`, `modifdate`) VALUES
	...
	(29, 5, 'gigih', 'ba', 'docprogres', 'gigih', '2021-02-22 11:14:46', NULL, NULL),
	(31, 10, 'gigih', 'ba', 'docprogres', 'gigih', '2021-02-22 16:11:52', NULL, NULL),
	(32, 5, 'gigih', 'ba', 'docdone', 'gigih', '2021-02-22 16:15:15', NULL, NULL),
	(33, 4, 'gigih', 'ba', 'docdone', 'gigih', '2021-02-23 05:57:48', NULL, NULL),
	(34, 4, 'paga', 'dev', 'devprogres', 'paga', '2021-02-23 05:58:15', NULL, NULL);
